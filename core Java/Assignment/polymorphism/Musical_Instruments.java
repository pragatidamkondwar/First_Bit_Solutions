...
class DemoMusical_Instrument
{
	public static void main(String[] args) {
		...
		mi = new Musical_Instrument ("Guitar", "String", 40, 3, 15000.50, "Low to High");
		mi.display();
		mi.Play();
		
		mi = new  Gitar ("Guitar", "String", 40, 3, 15000.50, "Low to High", 6, "Acoustic");
		mi.display();
		mi.Play();
		 
		mi = new piano ("Grand Piano", "Keyboard", 60, 300, 250000.00, "Wide Range", 88, 3);
		mi.display();
		mi.Play();
		
		mi = new Drum ("Snare Drum", "Percussion", 20, 7, 12000.00, "Medium Range", "Snare", 14.5);
		mi.display();
		mi.Play();
