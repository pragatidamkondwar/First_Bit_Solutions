 ...
 class Vehicle {
	...
	class Car extends Vehicle {
	        ...
	        int seats,  boolean sunroof)//parameterized constructor
	    {
		 ...
		 void setSunroof(boolean sunroof) {
			...
			void  brake()
			 {
				System.out.println("drmb breake applied");
			 }
	...
	class Bike extends Vehicle {
	    ...
	    Bike(String brand, String model, String vehicleNumber, String color,
		 ...
		 void setAnticlockbike(boolean anticlockbike) {
			...
			void  brake()
			 {
				System.out.println("disc breake applied");
			 }
	...
	class Truck extends Vehicle {
	    ...
	    Truck(String brand, String model, String vehicleNumber, String color,
		 ...
		 void setNoOfWheels(int noOfWheels) {
			...
			void  brake()
			 {
				System.out.println("air breake applied");
			 }
	...
	class DemoVehicle {
	    public static void main(String[] args) {
	    	Vehicle v1;
	    	v1 = new Vehicle ("Toyota", "Innova Crysta", "MH12AB1234", "White", 2500000.50, 180, "Diesel", 14.5, 2022);
	    	v1.display();
	    	v1.brake();
           
	    	
	        v1= new Car("Tata", "Nexon", "MH12AB1234", "Blue", 1200000, 180, "Petrol", 18.5, 2024,5, true);
	        v1.display();
	        v1.brake();
	        
	        

	        v1 = new Bike("Yamaha", "R15", "MH09XY4321", "Black", 165000, 150, "Petrol", 45.0, 2023, 155, true);	                          
	        v1.display();
	        v1.brake();
	        

	        v1 = new Truck("Ashok Leyland", "CargoX", "MH14TR9087", "White", 2500000, 120, "Diesel", 8.0, 2022, 16.5, 12);	                           
	        v1.display();
	        v1.brake();
	    }
	}
