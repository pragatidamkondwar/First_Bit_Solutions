...
public class Game {
		...
		String getName() {
		 ...
		 void play()
		 {
			 System.out.println(" player playing the game");
		 }
		}
		...
		class outdoorgame extends Game
		{
			...
			void display()
			{
			 ...
			 void play()
			 {
				 System.out.println("starting outside game");
			 }
		...
		class DemoGame
		{
			public static void main(String[] args) {
			    ...
			    g1=new Game(101, "GTA V", "Action", 4.8, 5, "pc");
				g1.display();
				g1.play();
				
				
				 g1 = new videogame(201, "GTA V", "Action-Adventure", 4.9, 1, "Rockstar Games",
				...
				g1= new Boardgame(  301, "Chess", "Strategy", 4.7, 2, "Hasbro",
			            8, 32, "Wood", "Classic Battle", 10);
				g1.display();
				g1.play();
				
				 g1= new outdoorgame( 401, "Cricket", "Sports", 4.9, 11, "ICC",
